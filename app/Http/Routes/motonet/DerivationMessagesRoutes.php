...
$controller = '\App\Http\Controllers\motonet\DerivationMessagesController';

Route::get('list'.$module.'/{id}',           ['middleware'=>'roles','data'=> $module.'-list' ,'as'=> $module,'uses'=> $controller.'@getIndex']);

Route::get('tomar'.$module.'/{id}',   ['middleware'=>'roles','data'=> $module.'-store' ,'as'=> $module.'Tomar','uses'=> $controller.'@tomar']);
