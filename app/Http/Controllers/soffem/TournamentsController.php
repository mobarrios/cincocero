...
use App\Http\Repositories\soffem\TournamentsRepo as Repo;
...
class TournamentsController extends Controller {
    ...
    public function destacadosPlayersGetNew($season_id = null , $cat_id = null)
    {
        ...
        return view('soffem.tournaments.formPlayersDestacados')->with($this->data);
    }
    ...
    public function destacadosTeamsGetNew($season_id = null , $cat_id = null)
    {
        ...
        return view('soffem.tournaments.formTeamsDestacados')->with($this->data);
    }
