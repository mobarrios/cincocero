                ...
                <table border="1" bordercolor="#dddddd" class="table table-hover table-striped table-responsive">
                  <tbody>
                        ...
                        @forelse($tablas as $tab)
                          ...
                          <tr>
                              <td colspan="2" align="center" class="active"><img src="{!! $tab->teams->images->count() > 0 ? $tab->teams->images->first()->image : 'assets/web/images/teamDefault.png'!!}" width="35" height="35" alt=""/></td>
                              <td colspan="2" align="center" class="active"><a href="{{route('equipo',[$categoriaActual->id,$faseActual->id,$tab->teams->id])}}">{!! '' !!}</a></td>
