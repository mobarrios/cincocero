        ...
        <div class="center-col">
            ...
            <div class="elements-box">
                ...
                <div class="row"><!-- col-md-4 --><!-- col-md-8 -->
                  <p><img src="images/jug.png" width="600" height="70" alt=""/></p>
                  <p>&nbsp;</p>
                </div>
                <table width="100%" border="0">
                  <tbody>
                    <tr>
                      <td width="18%"><img src="images/fabian.jpg" width="180" height="195" alt=""/></td>
                      <td width="8%">&nbsp;</td>
                ...
                <p>&nbsp;</p>
                <p><img src="images/equipo_fecha.png" width="600" height="70" alt=""/></p>
                <table width="100%" border="0">
                  <tbody>
                    <tr>
                      <td width="18%"><img src="images/equipo1.jpg" width="450" height="302" alt=""/></td>
                    </tr>
                  </tbody>
                </table>
                <p>                
...
<p>&nbsp;</p>
<p><img src="images/partido_fecha.png" width="600" height="70" alt=""/></p>
