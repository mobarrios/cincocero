...
<body class="uk-vertical-align uk-text-center tt-offline">
    ...
    <div class="uk-panel uk-width-1-1 uk-panel-box uk-vertical-align-middle message-offline uk-container-center">
        ...
        <table align="center" width="50%" border="0" class="responsive">
          <tbody>
            <tr>
              <td><a href="{!! route('new.torneos',[5,27]) !!}"><img src="../../../images/copa01.png" alt="The Futbol Company" class="img-polaroid"></a></td>
              <td><a href="{!! route('new.torneos',[5,25]) !!}"><img src="../../../images/copa02.png" alt="The Futbol Company" class="img-polaroid"></a></td>
              <td><a href="{!! route('new.torneos',[5,24]) !!}"><img src="../../../images/copa03.png" alt="The Futbol Company" class="img-polaroid"></a></td>
              <td><a href="{!! route('new.torneos',[5,26]) !!}"><img src="../../../images/copa04.png" alt="The Futbol Company" class="img-polaroid"></a></td>
              <td><a href="{!! route('new.torneos',[6,29]) !!}"><img src="../../../images/copa05.png" alt="The Futbol Company" class="img-polaroid"></a></td>
              <td><a href="{!! route('new.torneos',[5,28]) !!}"><img src="../../../images/copa06.png" alt="The Futbol Company" class="img-polaroid"></a></td>
            </tr>
            <tr>
