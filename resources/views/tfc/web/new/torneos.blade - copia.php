                    ...
                    <div class="uk-width-1-1">
                        <div class="uk-panel">
                            ...
                            <div class="va-latest-wrap">
                                <div class="uk-container uk-container-center">
                                    <div class="va-latest-top">
                                        <h3>Resultados  <span>de la Fecha</span></h3>
                                        <div class="tournament">
                                            <address>Cancha:8 Sede: AEFIP<br><br></address> </div>
                                        <div class="date">
                                            20-03-2016 / 11.45am</div>
                                    </div>
                                </div>
                                <div class="va-latest-middle uk-flex uk-flex-middle">
                                    <div class="uk-container uk-container-center">
                                        <div class="uk-grid uk-flex uk-flex-middle">
                                            <div class="uk-width-2-12 center">
                                                <a href="results.html">
                                                    <img src="images/teamDefault.png" class="img-polaroid" alt="" title="">
                                                </a>
                                            </div>
                                            <div class="uk-width-3-12 name uk-vertical-align">
                                                <div class="wrap uk-vertical-align-middle">
                                                    <h5>Cambridgehire</h5></div>
                                            </div>
                                            <div class="uk-width-2-12 score">
