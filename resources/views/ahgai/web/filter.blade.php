            ...
            <ul class="booking-list">
                <li>
                    <a class="booking-item">
                        <div class="row">
                            <div class="col-md-3">
                                <img src="web/img/800x600.png" alt="Image Alternative text" title="LHOTEL PORTO BAY SAO PAULO lobby" />
                            </div>
                            <div class="col-md-6">
                                <h5 class="booking-item-title">Standard Double room</h5>
                                <p class="text-small">Condimentum tempor suscipit porta elementum consectetur diam dignissim aptent augue maecenas ridiculus aliquam</p>
                            ...
                            <div class="col-md-3"><span class="booking-item-price">$284</span><span>/noche</span><span class="btn btn-primary">Book</span>
                            </div>
                        </div>
                    </a>
                </li>
                <li>
                    <a class="booking-item">
                        <div class="row">
                            <div class="col-md-3">
                                <img src="web/img/800x600.png" alt="Image Alternative text" title="hotel 2" />
                            </div>
                            <div class="col-md-6">
                                <h5 class="booking-item-title">Double Room with Town View</h5>
                                <p class="text-small">Suspendisse vulputate etiam convallis aptent justo aptent senectus quis volutpat vel at mus</p>
                                <ul class="booking-item-features booking-item-features-sign clearfix">
                                    <li rel="tooltip" data-placement="top" title="Adults Occupancy"><i class="fa fa-male"></i><span class="booking-item-feature-sign">x 2</span>
                                    </li>
                                    ...
                                    <li rel="tooltip" data-placement="top" title="Room footage (square feet)"><i class="im im-width"></i><span class="booking-item-feature-sign">510</span>
                                    </li>
                                </ul>
                                <ul class="booking-item-features booking-item-features-small clearfix">
                                    <li rel="tooltip" data-placement="top" title="Kitchen"><i class="im im-kitchen"></i>
                            ...
                            <div class="col-md-3"><span class="booking-item-price">$176</span><span>/noche</span><span class="btn btn-primary">Book</span>
                            </div>
                        </div>
                    </a>
                </li>
                <li>
                    <a class="booking-item">
                        <div class="row">
                            <div class="col-md-3">
                                <img src="web/img/800x600.png" alt="Image Alternative text" title="The pool" />
                            </div>
                            <div class="col-md-6">
                                <h5 class="booking-item-title">Family Suite</h5>
                                <p class="text-small">Ipsum fames habitant montes ullamcorper venenatis nullam feugiat dui eros himenaeos viverra mauris</p>
                                <ul class="booking-item-features booking-item-features-sign clearfix">
                            ...
                            <div class="col-md-3"><span class="booking-item-price">$446</span><span>/noche</span><span class="btn btn-primary">Book</span>
                            </div>
                        </div>
                    </a>
                </li>
                <li>
                    <a class="booking-item">
                        <div class="row">
                            <div class="col-md-3">
                                <img src="web/img/800x600.png" alt="Image Alternative text" title="hotel 1" />
                            </div>
                            <div class="col-md-6">
                                <h5 class="booking-item-title">Junior Suite</h5>
                                <p class="text-small">Aptent morbi consequat nam phasellus nunc sit mus viverra netus platea duis faucibus</p>
                                <ul class="booking-item-features booking-item-features-sign clearfix">
                                    <li rel="tooltip" data-placement="top" title="Adults Occupancy"><i class="fa fa-male"></i><span class="booking-item-feature-sign">x 1</span>
                                    </li>
                                    <li rel="tooltip" data-placement="top" title="Beds"><i class="im im-bed"></i><span class="booking-item-feature-sign">x 1</span>
                                    </li>
                                    <li rel="tooltip" data-placement="top" title="Room footage (square feet)"><i class="im im-width"></i><span class="booking-item-feature-sign">520</span>
                                    </li>
                                </ul>
                                <ul class="booking-item-features booking-item-features-small clearfix">
                                    <li rel="tooltip" data-placement="top" title="Air Conditioning"><i class="im im-air"></i>
                            ...
                            <div class="col-md-3"><span class="booking-item-price">$449</span><span>/noche</span><span class="btn btn-primary">Book</span>
                            </div>
                        </div>
                    </a>
                </li>
                <li>
                    <a class="booking-item">
                        <div class="row">
                            <div class="col-md-3">
                                <img src="web/img/800x600.png" alt="Image Alternative text" title="hotel PORTO BAY RIO INTERNACIONAL rooftop pool" />
                            </div>
                            <div class="col-md-6">
                                <h5 class="booking-item-title">Superior Penthouse</h5>
                                <p class="text-small">Tincidunt sem rhoncus malesuada magnis rutrum urna tristique tincidunt porta ullamcorper habitasse adipiscing</p>
                                <ul class="booking-item-features booking-item-features-sign clearfix">
                                    ...
                                    <li rel="tooltip" data-placement="top" title="Room footage (square feet)"><i class="im im-width"></i><span class="booking-item-feature-sign">380</span>
                                    </li>
                                </ul>
                                <ul class="booking-item-features booking-item-features-small clearfix">
                                    <li rel="tooltip" data-placement="top" title="Air Conditioning"><i class="im im-air"></i>
                            ...
                            <div class="col-md-3"><span class="booking-item-price">$262</span><span>/noche</span><span class="btn btn-primary">Book</span>
                            </div>
                        </div>
                    </a>
                </li>
